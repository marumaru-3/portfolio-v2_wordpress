...
<main>
  <section id="top">
    <p class="top-text">
      みんなに喜んでいただける<br class="top-text_br" />サイト制作を心がけています
    </p>
        ...
        <div class="about-right">
          <div class="about-text-contents">
            ...
            <div class="about-text">
              ...
              <p>
                以前、工場で働いていた頃、自分の仕事がお客様にどれだけ貢献できているのか、いつも自問自答していました。もっと自分のスキルを活かして、お客様に直接価値を提供したいという思いが強くなり、様々な仕事を探し求める中で、Web制作に出会いました。インターネットを日常的に利用していた私にとって、Web制作は身近な存在でありながら、多くの人々に影響を与えることができる仕事だと感じ、大きな衝撃を受けました。<br>
                その後、会社を辞め、プログラミングスクールや職業訓練のWebデザイナー科に通い、デザインからコーディングまで幅広く学びました。実際にWebサイトを作り上げる中で、コーディングの楽しさを実感し、この道で生きていきたいと決意しました。
              </p>
            </div>
            <div class="about-text">
              <h4>
            ...
            <div class="about-text">
              ...
              <ul class="about-text_list">
                ...
                <li>
                  <h5>筋トレ</h5>
                  <p>
                    週4で筋トレをしています。懸垂が一番得意です。最初はダイエットのために始めましたが、身体が大きくなったり重いものを持てるようになっていくのが楽しくなってきました。
                  </p>
                </li>
                <li>
                  <h5>食べること</h5>
