  ...
  <?php if (have_posts()): while (have_posts()): the_post(); ?>
      <div class="single-top">
        ...
        <div class="window-modal">
          ...
          <div class="window-contents window-contents-web-app pc-view">
            <ul class="tab-menu">
      ...
      <div class="single-info web-app-info">
        <div class="w-1200">
      ...
      <div class="other-works other-web-apps">
        <div class="w-1200">
          <div class="other-group">
            <h3>
              Other Web Apps
              <span>その他のWebアプリ</span>
            </h3>
            <ul class="other-list">
              <?php
              // 現在の投稿IDを取得
